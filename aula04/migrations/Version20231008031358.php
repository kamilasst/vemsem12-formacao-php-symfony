 ...
 */
final class Version20231008031358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Phone (id_phone INT AUTO_INCREMENT NOT NULL, student_id INT DEFAULT NULL, number VARCHAR(11) NOT NULL, INDEX IDX_858EB8D9CB944F1A (student_id), PRIMARY KEY(id_phone)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
