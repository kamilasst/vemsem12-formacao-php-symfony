...
if(isset($_POST["cadastro"])) {
   ...
   $cadastrouServico = $servicoEsteticoRepositorio->cadastrarServico($servico);

   if($cadastrouServico) {
       header("Location: admin.php");
   } else {
       echo "Algo deu errado no envio do servico";
   }
}
...
<head>
    ...
    <title>Clinica Estetica - Cadastrar Servico</title>
</head>
<body>
<main>
    ...
    <section class="container-form">
        <form method="POST">
            ...
            <input type="text" id="nome" name="nome" placeholder="Digite o nome do servico" required>
            <div class="container-radio">
                <div>
                    <label for="facial">Facial</label>
                    <input type="radio" id="facial" name="tipo" value="Facial" checked>
                </div>
                <div>
                    <label for="corporal">Corporal</label>
                    <input type="radio" id="corporal" name="tipo" value="Corporal" checked>
                </div>
            </div>
            ...
            <input type="text" id="preco" name="preco" placeholder="Digite o valor" required>

            <label for="imagem">Envie uma imagem do produto</label>
            <input type="file" name="imagem" accept="image/*" id="imagem" placeholder="Envie uma imagem">

            <input type="submit" name="cadastro" class="botao-cadastrar" value="Cadastrar serviço"/>
        </form>
